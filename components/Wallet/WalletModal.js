        ...
        <div style={styles.body}>
          ...
          {view === VIEWS.SELECT && (
            <div style={styles.optionList}>
              ...
              {/* Demo Mode */}
              <button
                style={{ ...styles.optionBtn, borderColor: "rgba(34,197,94,0.3)", background: "rgba(34,197,94,0.06)" }}
                onClick={connectDemo}
              >
                <div style={{ width: 40, height: 40, borderRadius: 8, background: "linear-gradient(135deg,#22c55e,#16a34a)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, flexShrink: 0 }}>
                  🎮
                </div>
                <div style={styles.optionInfo}>
                  <span style={styles.optionName}>Try Demo Mode</span>
                  <span style={styles.optionDesc}>Explore all features · no wallet needed</span>
                </div>
                <span style={{ ...styles.badge, color: "#22c55e", background: "rgba(34,197,94,0.15)" }}>FREE</span>
              </button>

              <div style={{ borderTop: "1px solid var(--tc-border, rgba(255,255,255,0.08))", margin: "4px 0" }} />
